...
function unloadCommand(commandName, commandsDir) {
  ...
  if (global.ownersv2.commands.has(commandName)) {
    global.ownersv2.commands.delete(commandName);
  }
  ...
  switch (action) {
    case 'install': {
      ...
      try {
        ...
        global.ownersv2.commands.set(commandModule.meta.name, commandModule);
